...
LDFLAGS += -L.
#^|
EXAMPLESOBJS=  adc.o buzzer.o colordecider.o displaypanel.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#7
...
#^|
adc.o: /cygdrive/C/eclipse/workspace/WLI/adc.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
buzzer.o: /cygdrive/C/eclipse/workspace/WLI/buzzer.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
colordecider.o: /cygdrive/C/eclipse/workspace/WLI/colordecider.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
displaypanel.o: /cygdrive/C/eclipse/workspace/WLI/displaypanel.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/WLI/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
adc.o: /cygdrive/C/eclipse/workspace/WLI/adc.cpp \
 /cygdrive/C/eclipse/workspace/WLI/adc.h \
...
buzzer.o: /cygdrive/C/eclipse/workspace/WLI/buzzer.cpp \
 /cygdrive/C/eclipse/workspace/WLI/buzzer.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/ltranadm.h
colordecider.o: /cygdrive/C/eclipse/workspace/WLI/colordecider.cpp \
 /cygdrive/C/eclipse/workspace/WLI/colordecider.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/ltranadm.h
displaypanel.o: /cygdrive/C/eclipse/workspace/WLI/displaypanel.cpp \
 /cygdrive/C/eclipse/workspace/WLI/displaypanel.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
